...
@section('title', 'Tes Bakat Minat SPMB — '.config('app.name'))
    ...
    <div class="container">
        <nav aria-label="breadcrumb" class="mb-2">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active text-white" aria-current="page">Tes Bakat Minat</li>
            </ol>
        </nav>
        <h1 class="display-6 fw-bold">Tes Bakat Minat SPMB {{ $yearLabel }}</h1>
    </div>
</section>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm text-center p-5">
                    ...
                    <p class="text-secondary mb-4">Informasi tes bakat minat SPMB {{ $yearLabel }} belum diumumkan. Silakan pantau halaman ini atau bagian <strong>Pengumuman SPMB</strong> untuk pembaruan resmi dari panitia.</p>
