            ...
            <ul class="navbar-nav mx-auto gap-lg-1 main-nav__items">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu main-nav__dropdown border-0">
                        ...
                        @endif
                        <li><a class="dropdown-item" href="{{ spmb_route('spmb.panduan-dapodik', '/spmb-2026/panduan-dapodik') }}"><i class="bi bi-book me-1 text-success"></i> Panduan Formulir Dapodik</a></li>
